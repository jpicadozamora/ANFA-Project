    ...
    <section id="contact" className="relative py-28 px-6 bg-black overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="grid md:grid-cols-5 gap-10">
          <form className="md:col-span-3 space-y-5 reveal-left" onSubmit={handleSubmit}>
          ...
          <div className="md:col-span-2 space-y-4 reveal-right">
            {[
              { icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z', title: 'Dirección', text: 'Av. Principal 123, Col. Centro\nCP 45000, Guadalajara, Jal.' },
              { icon: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z', title: 'Teléfono', text: '+52 (33) 1234 5678' },
              { icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', title: 'Correo', text: 'contacto@anfadellago.com' },
              { icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', title: 'Horario', text: 'Lun - Vie: 9:00 - 18:00\nSáb: 9:00 - 14:00' },
            ].map((info) => (
